...
class TradeAnalyzer(bt.Analyzer):
    ...
    记录每笔交易的详细信息，包括复权价格和实际价格
    """

    params = (
        ('original_price_map', {}),  # 不复权价格的日期映射
    )
    ...
    def notify_order(self, order):
        ...
        if order.status in [order.Completed]:
            ...
            original_prices = self.params.original_price_map.get(date_str, {})
            ...
            if order.isbuy():
                ...
                self.buy_original_price = original_prices.get('close', current_price)
                ...
                self.all_orders_list.append({
                    ...
                    'date': current_date,
                    'price': current_price,
                    'price_original': original_prices.get('close', current_price),
                ...
                if self.buy_order is not None:
                    ...
                    self.sell_original_price = original_prices.get('close', current_price)
